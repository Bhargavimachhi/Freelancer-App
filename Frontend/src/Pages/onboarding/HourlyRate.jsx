...
export default function HourlyRateForm() {
  ...
  const serviceFee = isNaN(hourlyRate * serviceFeePercentage)
    ? 0.0
    : hourlyRate * serviceFeePercentage;
  const youGet = isNaN(hourlyRate - serviceFee) ? 0.0 : hourlyRate - serviceFee;

  return (
    <>
      <div className="flex flex-col p-6 mx-auto my-4 max-w-7xl min-h-[70vh]">
          ...
          <div className="flex items-center justify-between pb-2 border-b ">
            <div>
              <h2 className="text-lg font-medium">
                Service fee{" "}
                <span className="cursor-pointer text-btn">Learn more</span>
              </h2>
            ...
            <div className="flex items-center gap-2">
              <span className="w-24 px-3 py-1 text-right border rounded-md">
